...
- Chromium breadcrumb regression - passed. It verifies the initial
  ...
  current crumb. Integration proofs snapped to 18 pixels from the viewport top
  with its horizontal center within three pixels of the viewport center. The
  breadcrumb's screen position stayed fixed after another 600 pixels of canvas
  scrolling.
